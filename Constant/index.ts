export const menus = [
  {
    ...
    subMenus: [
      { name: "Sub Menu 01", href: "/sub-01" },
      { name: "Sub Menu 02", href: "/sub-02" },
      { name: "Sub Menu 03", href: "/sub-03" },
    ],
  },
  {
    name: "Shop",
...
export const components: {
  ...
  },
  {
    ...
    description:
      "Make dishwashing a breeze with our powerful and effective dish detergents. Formulated to tackle tough grease and stains, our products leave your dishes sparkling clean and residue-free, so you can spend less time scrubbing and more time enjoying your meals.",
